...
import credo.ge.credoapp.DeleteActionActivity;
...
public class CustomFloatingViewService extends Service implements FloatingViewListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        iconView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // メールアプリの起動
                final Intent intent = new Intent(Intent.ACTION_SENDTO, Uri.fromParts("mailto", "mail3", null));
                intent.putExtra(Intent.EXTRA_SUBJECT, "mail");
                intent.putExtra(Intent.EXTRA_TEXT, "mail2");
    ...
    private Notification createNotification() {
        ...
        builder.setContentTitle("mail title");
